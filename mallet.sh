...
#build topic model
mallet-2.0.6/bin/mallet train-topics --input twitter-topic-input.mallet --inferencer-filename inferencer.mallet --num-topics 100 --output-state topic-state.gz --optimize-interval 150
